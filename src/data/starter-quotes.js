/**
 * Bundled fallback quotes.
 *
 * The full 6,486-quote library is fetched at runtime from /quotes/english.json.
 * These few travel inside the bundle so a failed fetch degrades to a working
...
export const STARTER_QUOTES = [
  ...
  },
  {
    ...
    "attr": "Charles Dickens"
  },
  {
    "text": "Call me Ishmael.",
    "attr": "Herman Melville"
  },
  {
  ...
  {
    "text": "Here is my secret: I only see clearly with my heart. What is essential is invisible to the eye.",
