...
describe('Run', () => {
  ...
  test('holds position on an error until the right key arrives', () => {
    const run = new Run('ab');
  ...
  test('clears the error mark once the character is typed correctly', () => {
    const run = new Run('ab');
    run.press('x', 0);
  ...
  test('does not record a digraph across an error', () => {
    ...
    // transition into the retyped character is skipped.
